package id.andriawan24.favorites.adapters
...
class FavoriteNewsAdapter(private val listener: NewsListener) :
    RecyclerView.Adapter<FavoriteNewsAdapter.ViewHolder>() {
